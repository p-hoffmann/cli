...
const errGlobal = `Installing Trex CLI as a global module is not supported.
Please use one of the supported package managers: https://github.com/p-hoffmann/trexsql#cli
`;
